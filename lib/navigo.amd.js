...
/* harmony import */ var _middlewares_checkForDeprecationMethods__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./middlewares/checkForDeprecationMethods */ "./src/middlewares/checkForDeprecationMethods.ts");
/* harmony import */ var _middlewares_checkForForceOp__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./middlewares/checkForForceOp */ "./src/middlewares/checkForForceOp.ts");
...
/* harmony import */ var _middlewares_processMatches__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./middlewares/processMatches */ "./src/middlewares/processMatches.ts");
/* harmony import */ var _middlewares_setLocationPath__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./middlewares/setLocationPath */ "./src/middlewares/setLocationPath.ts");
...
/* harmony import */ var _middlewares_waitingList__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./middlewares/waitingList */ "./src/middlewares/waitingList.ts");
...
function Navigo(appRoute, options) {
  ...
  var destroyed = false;
  var genericHooks;
  var isPushStateAvailable = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.pushStateAvailable)();
  var isWindowAvailable = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.windowAvailable)();

  if (!appRoute) {
    console.warn('Navigo requires a root path in its constructor. If not provided will use "/" as default.');
  } else {
    root = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(appRoute);
  }
  ...
  function composePathWithRoot(path) {
    return (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(root + "/" + (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(path));
  }

  function createRoute(path, handler, hooks, name) {
    path = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.isString)(path) ? composePathWithRoot(path) : path;
    return {
      name: name || (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(String(path)),
      path: path,
      handler: handler,
      hooks: (0,_utils__WEBPACK_IMPORTED_MODULE_8__.accumulateHooks)(hooks)
    };
  } // public APIs
  ...
  function resolve(to, options) {
    ...
    to = to ? (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(root) + "/" + (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(to) : undefined; // console.log("-- resolve --> " + to, self.__dirty);
    ...
    (0,_Q__WEBPACK_IMPORTED_MODULE_0__.default)([_middlewares_setLocationPath__WEBPACK_IMPORTED_MODULE_5__.default, _middlewares_matchPathToRegisteredRoutes__WEBPACK_IMPORTED_MODULE_3__.default, _Q__WEBPACK_IMPORTED_MODULE_0__.default.if(function (_ref) {
      var matches = _ref.matches;
      return matches && matches.length > 0;
    }, _middlewares_processMatches__WEBPACK_IMPORTED_MODULE_4__.default, _lifecycles__WEBPACK_IMPORTED_MODULE_9__.notFoundLifeCycle)], context, _middlewares_waitingList__WEBPACK_IMPORTED_MODULE_7__.default);
  ...
  function navigate(to, navigateOptions) {
    ...
    to = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(root) + "/" + (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(to);
    var context = {
      instance: self,
      to: to,
    ...
    (0,_Q__WEBPACK_IMPORTED_MODULE_0__.default)([_middlewares_checkForDeprecationMethods__WEBPACK_IMPORTED_MODULE_1__.default, _middlewares_checkForForceOp__WEBPACK_IMPORTED_MODULE_2__.default, _middlewares_matchPathToRegisteredRoutes__WEBPACK_IMPORTED_MODULE_3__.default, _Q__WEBPACK_IMPORTED_MODULE_0__.default.if(function (_ref2) {
      var matches = _ref2.matches;
      return matches && matches.length > 0;
    }, _middlewares_processMatches__WEBPACK_IMPORTED_MODULE_4__.default, _lifecycles__WEBPACK_IMPORTED_MODULE_9__.notFoundLifeCycle), _middlewares_updateBrowserURL__WEBPACK_IMPORTED_MODULE_6__.default, _middlewares_waitingList__WEBPACK_IMPORTED_MODULE_7__.default], context, _middlewares_waitingList__WEBPACK_IMPORTED_MODULE_7__.default);
  }
  ...
  function off(what) {
    this.routes = routes = routes.filter(function (r) {
      if ((0,_utils__WEBPACK_IMPORTED_MODULE_8__.isString)(what)) {
        return (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(r.path) !== (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(what);
      } else if ((0,_utils__WEBPACK_IMPORTED_MODULE_8__.isFunction)(what)) {
  ...
  function updatePageLinks(_ref3) {
    var removeExisting = _ref3.removeExisting;
    ...
    findLinks().forEach(function (link) {
      ...
      if (!link.hasListenerAttached) {
        ...
        link.navigoHandler = function (e) {
          ...
          var options = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.parseNavigateOptions)(link.getAttribute("data-navigo-options"));

          if (!destroyed) {
            e.preventDefault();
            e.stopPropagation();
            self.navigate((0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(location), options);
          }
        };
  ...
  function link(path) {
    return "/" + root + "/" + (0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(path);
  }
  ...
  function pathToMatchObject(path) {
    var _extractGETParameters = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.extractGETParameters)((0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)(path)),
        url = _extractGETParameters[0],
        queryString = _extractGETParameters[1];

    var params = queryString === "" ? null : (0,_utils__WEBPACK_IMPORTED_MODULE_8__.parseQuery)(queryString);
    var hashString = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.extractHashFromURL)(path);
  ...
  function getCurrentLocation() {
    return pathToMatchObject((0,_utils__WEBPACK_IMPORTED_MODULE_8__.clean)((0,_utils__WEBPACK_IMPORTED_MODULE_8__.getCurrentEnvURL)(root)).replace(new RegExp("^" + root), ""));
  }
  ...
  function directMatchWithLocation(path, currentLocation, annotatePathWithRoot) {
    ...
    (0,_middlewares_setLocationPath__WEBPACK_IMPORTED_MODULE_5__.default)(context, function () {});

    if (typeof path === "string") {
      path = typeof annotatePathWithRoot === "undefined" || annotatePathWithRoot ? composePathWithRoot(path) : path;
    }

    var match = (0,_utils__WEBPACK_IMPORTED_MODULE_8__.matchRoute)(context, {
      name: String(path),
      path: path,
  ...
  this.extractGETParameters = function (url) {
    return (0,_utils__WEBPACK_IMPORTED_MODULE_8__.extractGETParameters)(_checkForAHash(url));
  };
  ...
  this._clean = _utils__WEBPACK_IMPORTED_MODULE_8__.clean;
